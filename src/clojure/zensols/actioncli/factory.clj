(ns ^{:doc "Provides a logger factory for Log4J2.  I've added a request to add this to
the [Clojure logging](https://github.com/clojure/tools.logging) project with
[this request](http://dev.clojure.org/jira/browse/TLOG-19)"
      :author "Paul Landes"}
